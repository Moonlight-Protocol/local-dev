...
# ============================================================
section "2/10  Jaeger (ports 4317/4318/16686)"
# ============================================================
...
# ============================================================
section "4/10  PostgreSQL (port $PG_PORT)"
# ============================================================
...
# ============================================================
section "5/10  Provider Platform (port $PROVIDER_PORT)"
# ============================================================
...
# ============================================================
section "6/10  Council Platform (port $COUNCIL_PLATFORM_PORT)"
# ============================================================
...
# ============================================================
section "7/10  Pay Platform (port $PAY_PLATFORM_PORT)"
# ============================================================

cd "$PAY_PLATFORM_PATH"

# Infra-only env: ports, network bindings, DB URL, JWT secret. Notably NOT
# in here, by design:
...
# ============================================================
section "8/10  Provider Console (port $PROVIDER_CONSOLE_PORT)"
# ============================================================
...
# ============================================================
section "9/10  Council Console (port $COUNCIL_CONSOLE_PORT)"
# ============================================================
...
# ============================================================
section "10/10 Network Dashboard (port $NETWORK_DASHBOARD_PORT)"
# ============================================================
